...
void ICP3D::cloudCallback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{
    if (_is_initial) {
        ...
        _prev_transformation = Eigen::Matrix4f::Identity();
        ...
        Eigen::Matrix4f init_guess = init_guess_imu*_prev_transformation;
        /////////////////////////////////////////////////////////////////////////////////        
